...
public class BackPageWidget extends ClickableWidget {
	public float x;
	public float y;
	...
	public BackPageWidget(int x, int y, BookOfTheDeadTab tab, BookOfTheDeadScreen screen) {
		super(x, y, 18, 12, ChatNarratorManager.NO_TITLE);
		this.x = x;
		this.y = y;
		this.tab = tab;
		this.screen = screen;
	...
	public void drawWidget(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		...
		matrices.push();
		RenderUtils.drawTexture(matrices, this.x, this.y, 272, 9, 18, 12, 512, 256);
		matrices.pop();
	}
