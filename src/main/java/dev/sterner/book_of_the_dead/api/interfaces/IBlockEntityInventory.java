...
public interface IBlockEntityInventory extends Inventory {

	static IBlockEntityInventory ofSize(int size) {
		return of(DefaultedList.ofSize(size, ItemStack.EMPTY));
	}

	static IBlockEntityInventory of(DefaultedList<ItemStack> items) {
		return () -> items;
	}
