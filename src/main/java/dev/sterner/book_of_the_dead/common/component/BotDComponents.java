...
public class BotDComponents implements EntityComponentInitializer {
	...
	public static final ComponentKey<PlayerEyeComponent> EYE_COMPONENT = ComponentRegistry.getOrCreate(Constants.id("eye"), PlayerEyeComponent.class);
	...
	public void registerEntityComponentFactories(EntityComponentFactoryRegistry registry) {
		...
		registry.beginRegistration(PlayerEntity.class, EYE_COMPONENT).respawnStrategy(RespawnCopyStrategy.NEVER_COPY).end(PlayerEyeComponent::new);
	}
}
